/**
 * @file server/src/domain/reconcile.ts
 ...
 *   - Does NOT own: Data persistence, API handling
 *
...
import { ReferralEvent, ReconciledMap, ReferralState, Status, Appointment } from "./models.js";
